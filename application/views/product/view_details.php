<div class="row mt-5">
  ...
  <div class="col-sm-12">
    ...
    <div class="row mt-3 mb-3">
      ...
      echo viewDetailsCol('Product Name','Product1',3);
      echo viewDetailsCol('Product Code','P1223',3);
      echo viewDetailsCol('sku','sku-123',3);
      echo viewDetailsCol('Product Category','cat1',3);
